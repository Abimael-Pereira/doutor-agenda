...
const formSchema = z
  .object({
    ...
    availableFromWeekDay: z.string().min(0).max(6, "Dia da semana inválido"),
    availableToWeekDay: z.string().min(0).max(6, "Dia da semana inválido"),
  ...
  return (
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription>
          {doctor ? "Edite os dados do médico" : "Preencha os dados do médico"}
        </DialogDescription>
      </DialogHeader>
      <Form {...form}>
            ...
            {doctor && (
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>
                      Você tem certeza que deseja deletar esse médico?
                    </AlertDialogTitle>
                    <AlertDialogDescription>
